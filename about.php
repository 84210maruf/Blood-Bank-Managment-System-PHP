...
<body>
	...
	<div class="headersection templete clear">
		...
		<div class="logo clear">
			<img src="image/red.png" alt="mylogo"/>
			<h3>BLOOD DONORS BD</h3>
			<p>Blood is Love</p>
	...
	<div class="navsection templete">
		<ul>
			...
			<li><a  href="BloodDonorList.html">Blood Donors List</a></li>
			<li><a href="#">Donors by Group</a>
						<ul>
							<li><a href="A_positive.html">A+(positive)</a></li>
							<li><a href="A_negative.html">A-(negative)</a></li>
							<li><a href="B_positive.html">B+(positive)</a></li>
							<li><a href="B_negative.html">B-(negative)</a></li>
							<li><a href="O_positive.html">O+(positive)</a></li>
							<li><a href="O_negative.html">O-(negative)</a></li>
							<li><a href="AB_positive.html">AB+(positive)</a></li>
							<li><a href="AB_negative.html">AB-(negative)</a></li>
							
						</ul>			</li>
						<li><a href="reg.html">Be A Donor</a></li>
...
<div class="about clear">
			...
			<div class="me clear">
				<h2>MD.MARUF HASSAN</h2>
				<img src="image/maruf.jpg" sizes="" alt="Post image" >
				<p>
			...
			<div class="me clear">
				<h2>WAHIDUR RAHMAN RAJ</h2>
				<img src="image/raj.jpg" sizes="" alt="Post image" >
				<p>
					 Sidebar Text will be go there.Sidebar Text will be go there.Sidebar Text will be go there. Sidebar Text will be go there.Sidebar Text will be go there.
					 Sidebar Text will be go there.Sidebar Text will be go there.Sidebar Text will be go there. Sidebar Text will be go there.Sidebar Text will be go there.
				</p>
			...
			<div class="me clear">
				<h2>RAMIM HASSAN</h2>
				<img src="image/ramim.jpg" sizes="" alt="Post image" >
				<p>
				Sidebar Text will be go there.Sidebar Text will be go there.Sidebar Text will be go there. Sidebar Text will be go there.Sidebar Text will be go there.
				Sidebar Text will be go there.Sidebar Text will be go there.Sidebar Text will be go  there. Sidebar Text will be go there.Sidebar Text will be go there.</p>
			</div>
			<div class="me clear">
				<iframe width="560" height="315" src="https://www.youtube.com/embed/BPRRU1m9VYY" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
			</div>	
